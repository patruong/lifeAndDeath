...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  9 14:51:33 2021

@author: ptruong

Same as ws_20210408 but with cleaning between steps multiplyting with df_signal
"""
...
df_aitchison = aitchison_transform(df_int)
...
kde_matrix_plot_all_channels(df_aitchison, log = False, suptitle ="Aitchison")

kde_matrix_plot_batch(df_int, log = True, suptitle = "log2(Raw intensity) (Channel intensities together)", legend_size = 6)
kde_matrix_plot_batch(df_aitchison, log = False, suptitle = "Aitchison (Channel intensities together)", legend_size = 6)
...
df_norm_ait = norm_SL(df_aitchison)

kde_matrix_plot_all_channels(df_norm, log = True, suptitle ="log2(norm)")
kde_matrix_plot_all_channels(df_norm_ait, log = False, suptitle ="Aitchison norm")
kde_matrix_plot_batch(df_norm, log = True, suptitle = "log2(Norm intensity) (Channel intensities together)", legend_size = 6)
kde_matrix_plot_batch(df_norm_ait, log = False, suptitle = "Aitchison norm (Channel intensities together)", legend_size = 6)
...
kde_matrix_plot_batch(data_corrected, log = True, suptitle = "log2(Combta intensity) (Channel intensities together)", legend_size = 6)

kde_matrix_plot_all_channels(data_corrected_ait, log = False, suptitle ="Aitchison ComBat")
kde_matrix_plot_batch(data_corrected_ait, log = False, suptitle = "Aitchison Combat (Channel intensities together)", legend_size = 6)
...
kde_matrix_plot_all_channels((data_corrected*df_signal).replace(0,np.nan), log = True, suptitle = "log2(ComBat), adjusted")
kde_matrix_plot_batch((data_corrected*df_signal).replace(0,np.nan), log = True, suptitle = "log2(Combat intensity), adjusted (Channel intensities together)", legend_size = 6)

kde_matrix_plot_all_channels((data_corrected_ait*df_signal).replace(0,np.nan), log = False, suptitle ="Aitchison ComBat, adjusted")
kde_matrix_plot_batch((data_corrected_ait*df_signal).replace(0,np.nan), log = False, suptitle = "Aitchison Combat (Channel intensities together), adjusted", legend_size = 6)


#############################################################################################
# AITCHISON AFTER COMBAT - not we are removing all signals that combat adjusted to negative #
#############################################################################################

data_corrected_adj = (data_corrected*df_signal).replace(0,np.nan)
data_ait_after_combat = aitchison_transform(data_corrected_adj[data_corrected_adj  > 0])

kde_matrix_plot_all_channels(data_ait_after_combat, log = False, suptitle = "Aitchison after ComBat, adjusted")
kde_matrix_plot_batch(data_ait_after_combat, log = False, suptitle = "Aitchison after Combat, adjusted1 (Channel intensities together)", legend_size = 6)
