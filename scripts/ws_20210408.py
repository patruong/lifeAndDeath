...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  9 01:36:50 2021
...
##########################
# AITCHISON AFTER COMBAT #
##########################

# NOTE THIS! 
data_ait_after_combat = aitchison_transform(data_corrected) # CAnnot because ComBat causes negative 

data_ait_after_combat = aitchison_transform(data_corrected[data_corrected  > 0])

kde_matrix_plot_all_channels(data_ait_after_combat, log = False, suptitle = "Aitchison after ComBat")
kde_matrix_plot_batch(data_ait_after_combat, log = False, suptitle = "Aitchison after Combat (Channel intensities together)", legend_size = 6)
...
df_part = df_part[(df_part.T != 0).any()]
df_ait_part = aitchison_transform_part(df_part)
...
plot_kde(df_part, title = "A549_D_Rep2")
plot_kde(df_ait_part, log = False, title = "Aitchison")
...
plot_kde_batch(df_int)
plot_kde_batch(df_aitchison, log = False)
