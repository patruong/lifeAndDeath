...
kde_matrix_plot_batch(data_corrected, log = True, suptitle = "log2(ComBat intensity) (Channel intensities together)", legend_size = 6)
...
data_corrected_aitchison = aitchison_transform(data_corrected_filtered) # Aitchison > 0 filtered

kde_matrix_plot_all_channels(data_corrected_aitchison, log = False, suptitle ="Aitchison")
kde_matrix_plot_batch(data_corrected_aitchison, log = False, suptitle = "Aitchison (Channel intensities together)", legend_size = 6)
...
data_corrected_adj_aitchison = aitchison_transform(data_corrected_adj[data_corrected_adj > 0]) # Aitchison > 0, true signal adjusted
                 
kde_matrix_plot_all_channels(data_corrected_adj_aitchison, log = True, suptitle ="Aitchison, adjusted")
kde_matrix_plot_batch(data_corrected_adj_aitchison, log = True, suptitle = "Aitchison, adjusted (Channel intensities together)", legend_size = 6)
