...
data_aitchison = aitchison_transform(df_int)
...
data_aitchison_adj = aitchison_transform(data_aitchison_adj[data_aitchison_adj > 0]) # Aitchison > 0, true signal adjusted
