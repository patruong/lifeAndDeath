...
df_combat_adj = df_combat*df_signal
kde_matrix_plot_all_channels(df_combat_adj, log = True, suptitle ="log2(ComBat), adjusted")
kde_matrix_plot_batch(df_combat_adj, log = True, suptitle = "log2(ComBat intensity), adjusted (Channel intensities together)", legend_size = 6)
...
data_aitchison = aitchison_transform(df_norm[df_norm>0])
